			...
			<div class="panel panel-default">
				...
				<!-- 	<form:form method="POST" action="/j_spring_security_check">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<form:input path="j_username" class="form-control" required="true" title="User id must contain 4 to 15 characters"
									 pattern=".{4,15}" />
									<br>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<form:input type="password" path="j_password" required="true" title="Password must contain 8 to 15 characters"
					...
					<form method="POST" action="/j_spring_security_check">
							...
							<div class="form-group">
								<label class="control-label col-sm-offset-1 col-sm-3 text-right fontstyle">User Id<span
										class="red">*</span>
								</label>
								<div class="col-sm-7">
									<input name="j_username" class="form-control" required="true" title="User id must contain 4 to 15 characters"
									 pattern=".{4,15}" />
									<br>
									</div>
								<br>
							...
							<div class="form-group">
								...
								<label>
								<div class="col-sm-7">
									<input type="password" name="j_password" required="true" title="Password must contain 8 to 15 characters"
										class="form-control" pattern=".{8,15}"/>
											<a href="forgotPassword" class="help-text pull-right">Forgot Password?</a>
									<br>
